...
public final class ResourceServerDefaults {
    ...
    /**
     * Applies stateless bearer-token security, security headers and RFC 9457 error rendering.
     */
    public static void apply(HttpSecurity http) throws Exception {
        http
                ...
                // CORS is handled solely at the gateway - the only origin a browser ever talks
                // to.
    ...
    /** Maps the token's roles claim onto Spring Security authorities. */
